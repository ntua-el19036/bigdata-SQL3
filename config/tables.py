...
tables_dict = [
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'DATE', 'DATE', 'INTEGER', 'INTEGER', 'VARCHAR(50)',
            'VARCHAR(50)', 'INTEGER', 'INTEGER', 'VARCHAR(20)', 'VARCHAR(40)', 'INTEGER', 'VARCHAR(50)', 'VARCHAR(100)',
            'VARCHAR(40)', 'INTEGER', 'VARCHAR(50)', 'INTEGER', 'VARCHAR(50)', 'VARCHAR(10)', 'VARCHAR(60)',
            'VARCHAR(15)', 'VARCHAR(10)', 'VARCHAR(60)', 'VARCHAR(30)', 'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DECIMAL(5,2)',
            'DECIMAL(5,2)'
            ]
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'INTEGER', 'INTEGER', 'VARCHAR(50)', 'INTEGER', 'INTEGER',
    ...
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 
            'VARCHAR(10)', 'VARCHAR(20)', 'VARCHAR(30)', 'VARCHAR(1)', 'INTEGER', 'INTEGER', 
            'INTEGER', 'VARCHAR(20)', 'VARCHAR(13)', 'VARCHAR(50)', 'INTEGER',
            ]
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'VARCHAR(10)', 'VARCHAR(60)', 'VARCHAR(15)', 'VARCHAR(10)', 'VARCHAR(60)', 
            'VARCHAR(30)', 'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DECIMAL(5,2)', 'VARCHAR(20)'
            ]
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(1)', 'VARCHAR(1)', 'VARCHAR(20)', 'INTEGER', 'VARCHAR(10)', 'INTEGER', 
            'INTEGER', 'INTEGER'
            ]
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'DATE', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER',
            'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 
            'VARCHAR(9)', 'VARCHAR(6)', 'VARCHAR(1)', 'VARCHAR(1)', 'VARCHAR(1)', 'INTEGER', 'INTEGER', 
            'INTEGER', 'INTEGER', 'VARCHAR(1)', 'VARCHAR(1)', 'VARCHAR(1)', 'VARCHAR(1)', 'VARCHAR(1)'
            ]
    },
    {
        ...
        'column_datatypes': ['VARCHAR(16)', 'DATE', 'TIME', 'VARCHAR(200)']
    },
    {
        ...
        'column_datatypes': ['INTEGER', 'INTEGER', 'VARCHAR(15)', 'INTEGER', 'INTEGER']
    },
    {
        ...
        'column_datatypes': ['INTEGER', 'INTEGER', 'INTEGER']
    },
    {
        ...
        'column_datatypes': ['INTEGER', 'INTEGER', 'INTEGER', 'INTEGER']
    },
    {
        'table_name': 'item',
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'DATE', 'DATE', 'VARCHAR(200)', 'DECIMAL(7,2)', 'DECIMAL(7,2)',
            'INTEGER', 'VARCHAR(50)', 'INTEGER', 'VARCHAR(50)', 'INTEGER', 'VARCHAR(50)', 'INTEGER', 
            'VARCHAR(50)', 'VARCHAR(20)', 'VARCHAR(20)', 'VARCHAR(20)', 'VARCHAR(10)', 'VARCHAR(10)', 'INTEGER', 
            'VARCHAR(50)'
            ]
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'INTEGER', 'INTEGER', 'INTEGER', 'DECIMAL(15,2)', 'INTEGER',
    ...
    },
    {
        ...
        'column_datatypes': ['INTEGER', 'VARCHAR(16)', 'VARCHAR(100)']
    },
    {
        ...
        'column_datatypes': ['INTEGER', 'VARCHAR(16)', 'VARCHAR(30)', 'VARCHAR(10)', 'VARCHAR(20)', 'VARCHAR(20)']
    },
    {
        'table_name': 'store',
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'DATE', 'DATE', 'INTEGER', 'VARCHAR(50)', 'INTEGER',
            'INTEGER', 'VARCHAR(20)', 'VARCHAR(40)', 'INTEGER', 'VARCHAR(100)', 'VARCHAR(100)', 'VARCHAR(40)', 'INTEGER'
            'VARCHAR(50)', 'INTEGER', 'VARCHAR(50)', 'VARCHAR(10)', 'VARCHAR(60)', 'VARCHAR(15)', 'VARCHAR(10)', 'VARCHAR(60)'
            'VARCHAR(30)', 'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DECIMAL(5,2)', 'DECIMAL(5,2)'
            ]
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 
            'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'DECIMAL(7,2)', 'DECIMAL(7,2)', 
            'DECIMAL(7,2)', 'DECIMAL(7,2)', 'DECIMAL(7,2)', 'DECIMAL(7,2)', 'DECIMAL(7,2)', 
            'DECIMAL(7,2)', 'DECIMAL(7,2)', 'DECIMAL(7,2)', 'DECIMAL(7,2)', 'DECIMAL(7,2)'
            ]
    },
    ...
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'VARCHAR(2)', 
    ...
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'VARCHAR(20)', 'INTEGER', 'VARCHAR(10)', 'VARCHAR(60)', 'VARCHAR(15)',
            'VARCHAR(10)', 'VARCHAR(60)', 'VARCHAR(30)', 'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DECIMAL(5,2)'
            ]
    },
    {
        'table_name': 'web_page',
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'DATE', 'DATE', 'INTEGER', 'INTEGER', 'VARCHAR(1)',
            'INTEGER', 'VARCHAR(100)', 'VARCHAR(50)', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER'
            ]
    },
    {
    ...
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'DATE', 'DATE', 'VARCHAR(50)', 'INTEGER', 'INTEGER',
            'VARCHAR(50)', 'VARCHAR(40)', 'INTEGER', 'VARCHAR(50)', 'VARCHAR(100)', 'VARCHAR(40)', 'INTEGER', 'VARCHAR(50)',
            'VARCHAR(10)', 'VARCHAR(60)', 'VARCHAR(15)', 'VARCHAR(10)', 'VARCHAR(60)', 'VARCHAR(30)',
            'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DECIMAL(5,2)', 'DECIMAL(5,2)'
            ]
    },
]