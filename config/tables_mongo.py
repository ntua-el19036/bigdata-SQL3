...
tables_dict = [
    ...
    },
    {
        ...
        'column_datatypes': [
            'INT', 'STRING', 'DATE', 'DATE', 'INT', 'INT', 'STRING',
            'STRING', 'INT', 'INT', 'STRING', 'STRING', 'INT', 'STRING', 'STRING',
            'STRING', 'INT', 'STRING', 'INTEGER', 'STRING', 'STRING', 'STRING',
    ...
    },
    {
        ...
        'column_datatypes': [
            'INT', 'STRING', 'STRING', 'STRING', 'INT', 'STRING', 'INT', 
            'INT', 'INT'
            ]
    },
    {
        ...
        'column_datatypes': [
            'INT', 'STRING', 'DATE', 'DATE', 'STRING', 'DOUBLE', 'DOUBLE',
    ...
    },
    {
        ...
        'column_datatypes': ['INT', 'INT', 'STRING', 'INT', 'INT']
    },
    {
        'table_name': 'time_dim',
    ...
    },
    {
        ...
        'column_datatypes': [
            'INT', 'STRING', 'DATE', 'DATE', 'STRING', 'INT', 'INT',
    ...
    },
    {
        ...
        'column_datatypes': ['INT', 'STRING', 'STRING']
    },
    {
        ...
        'column_datatypes': ['INT', 'STRING', 'STRING', 'STRING', 'STRING', 'STRING']
    },
    {
        ...
        'column_datatypes': [
            'INT', 'STRING', 'INT', 'INT', 'INT', 'DOUBLE', 'INT',
    ...
    },
    {
        ...
        'column_datatypes': ['STRING', 'DATE', 'TIME', 'STRING']
    },
    {
        'table_name': 'web_page',
    ...
    },
    {
        ...
        'column_datatypes': [
            'INT', 'STRING', 'DATE', 'DATE', 'INT', 'STRING', 'INT',
            'INT', 'STRING', 'STRING', 'INT', 'STRING', 'STRING', 'STRING', 'INTEGER',
