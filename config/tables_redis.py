...
tables_dict = [
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'VARCHAR(10)', 'VARCHAR(10)', 'INTEGER', 'INTEGER', 'VARCHAR(50)',
            ...
            'VARCHAR(15)', 'VARCHAR(10)', 'VARCHAR(60)', 'VARCHAR(30)', 'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DOUBLE',
            'DOUBLE'
            ]
    },
    {
    ...
    },
    {
        ...
        'column_datatypes': [
            ...
            'VARCHAR(30)', 'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DOUBLE', 'VARCHAR(20)'
            ]
    },
    {
    ...
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'VARCHAR(10)', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER',
            'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 'INTEGER', 
    ...
    },
    {
        ...
        'column_datatypes': ['VARCHAR(16)', 'VARCHAR(10)', 'TIME', 'VARCHAR(200)']
    },
    {
    ...
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'VARCHAR(10)', 'VARCHAR(10)', 'VARCHAR(200)', 'DOUBLE', 'DOUBLE',
    ...
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'VARCHAR(10)', 'VARCHAR(10)', 'INTEGER', 'VARCHAR(50)', 'INTEGER',
            ...
            'VARCHAR(30)', 'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DOUBLE', 'DOUBLE'
            ]
    },
    {
    ...
    },
    {
        ...
        'column_datatypes': [
            ...
            'VARCHAR(10)', 'VARCHAR(60)', 'VARCHAR(30)', 'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DOUBLE'
            ]
    },
    {
        'table_name': 'web_page',
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'VARCHAR(10)', 'VARCHAR(10)', 'INTEGER', 'INTEGER', 'VARCHAR(1)',
    ...
    },
    {
        ...
        'column_datatypes': [
            'INTEGER', 'VARCHAR(16)', 'VARCHAR(10)', 'VARCHAR(10)', 'VARCHAR(50)', 'INTEGER', 'INTEGER',
            ...
            'VARCHAR(2)', 'VARCHAR(10)', 'VARCHAR(20)', 'DOUBLE', 'DOUBLE'
            ]
    },
]