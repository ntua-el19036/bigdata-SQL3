...
# source q12_variation.sh i web_sales item date_dim
# source q19_variation.sh i date_dim store_sales item customer customer_address store
# source q40_variation.sh i catalog_sales catalog_returns warehouse item date_dim
...
# source q94_variation.sh 1 web_sales date_dim customer_address web_site web_sales web_returns
