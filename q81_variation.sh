...
sed_args="6 s/catalog_returns/$2.catalog_returns/g;"
sed_args+="7 s/date_dim/$3.date_dim/g;"
sed_args+="8 s/customer_address/$4.customer_address/g;"
sed_args+="18 s/customer_address/$4.customer_address/g;"
sed_args+="19 s/customer/$5.customer/g;"
